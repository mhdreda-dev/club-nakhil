  ...
  return (
    <Card>
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="font-heading text-2xl uppercase tracking-[0.05em] text-white">Announcements</h2>
          <p className="mt-1 text-sm text-club-muted">Stay updated on schedule changes and reminders.</p>
        </div>
            ...
            >
              ...
              <div className="mt-3 flex flex-wrap items-center justify-between gap-2">
                <span className="text-[10px] font-bold uppercase tracking-[0.16em] text-red-200/80">
                  Coach {announcement.coach.name}
                </span>
                <span className="text-[10px] text-club-muted">{formatReadableDateTime(announcement.createdAt)}</span>
              </div>
            </article>
          ))
        )}
